...
## Data Preprocessing
 ...
 3. Now you can generate training and testing data using this script. Please config the dataset and scene name in the preprocessing.py file before running this:
```
cd processing
